...
$('nav#'+panel).toggle('fast','linear');}}},Get:{chapter:function(){var url,i,makeUrl=function(){return MCR.Tool.buildUrl(MCR.Global.request.manga,MCR.Global.request.chapter,MCR.TMP.page);},updateSelect=function(){},imgTag=function(page){var t=MCR.Global.manga.title+' / '+
