...
$('article ul').html(h);MCR.Do.displayStatus('');if(MCR.Option.switched("horizontal")){MCR.TMP.width=0;$('article img').each(function(){var w=$(this).width();if(w<800){w=800;}
